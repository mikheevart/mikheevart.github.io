...
Приветствую, меня зовут **{{ site.author.name }}** :wave:,<br>
- я **веб-разработчик** широкого профиля, работаю с проектами разной сложности (от одностраничных сайтов до CRM систем).
